...
function LoginComponent() {
  ...
  return (
    <div className="p-8 text-center w-full min-h-[calc(100vh-56px)] flex flex-col items-center justify-center">
      <div className="w-full max-w-md mx-auto bg-white/90 backdrop-blur rounded-2xl shadow-xl border border-slate-100 p-8">
        <h1 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 mb-6 transition-all hover:scale-105">
          TalkToDoc AI
        </h1>
        <Auth
